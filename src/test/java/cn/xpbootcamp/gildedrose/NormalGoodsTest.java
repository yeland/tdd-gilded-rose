...
public class NormalGoodsTest {
    ...
    @Test
    void should_get_sellIn_is_9_quantity_is_0_when_pass_one_day_given_a_normal_goods_with_sellIn_is_10_quantity_is_0() {
        NormalGoods normalGoods = new NormalGoods(10, 0);
        normalGoods.passOneDay();
        assertEquals(9, normalGoods.getSellIn());
